var app = ( function() {
    ...
    function initModels() {
        ...
        createModel("torus", f, [ 1, 1, 1, 1 ], mDefault, //"textures/y.png",
			[ 0, 0, 0 ], [ 0, Math.PI/2, 0], [ 1, 1, 1 ],
			"textures/rainbow_karos.png");
	 ...
	 */
	function createModel(geometryname, fillstyle, color, material, translate, rotate, scale,
	  textureFilename) {
		var model = {};
